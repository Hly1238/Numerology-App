import 'package:best_me_project/authentication/presentation/widgets/form_input.dart';
import 'package:best_me_project/authentication/presentation/widgets/welcome_widget.dart';
...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    ...
    //   body: SafeArea(
    //     child: SingleChildScrollView(
    //       // Dùng SingleChildScrollView để cuộn toàn bộ phần bên trong
    //       child: Container(
    //         width: double.infinity,
    //         decoration: BoxDecoration(
    //           image: DecorationImage(
